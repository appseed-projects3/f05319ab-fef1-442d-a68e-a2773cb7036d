...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-18 13:40`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f05319ab-fef1-442d-a68e-a2773cb7036d.git
$ cd f05319ab-fef1-442d-a68e-a2773cb7036d
```
